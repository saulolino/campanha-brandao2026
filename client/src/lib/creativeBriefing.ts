    ...
    posts: [
      {
        ...
        doList: [
          ...
          "Incluir logo da campanha no canto inferior",
        ],
        dontList: [
        ...
        adBudget: "R$ 150",
        notes: "Post de abertura da campanha digital. Impulsionar com R$ 150 focando em Brasília e entorno. Segmentação: 25-55 anos, interesses em meio ambiente, política local, qualidade de vida.",
      },
      {
        id: "brief-w1-2",
        day: "Quinta-feira",
    ...
    posts: [
      {
        ...
        visualDirection: "Antes/depois com slider visual. Fotos reais de alta qualidade. Tipografia bold. Cores da campanha.",
