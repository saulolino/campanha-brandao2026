...
const AUGUST_TITLES = [
  ...
  "Bastidores: preparação para a pré campanha",
  ...
  "Resultado: 3 meses de pré campanha em números",
...
const SEPTEMBER_TITLES = [
  ...
  "Dados finais: impacto da pré campanha nas redes",
...
const OCTOBER_TITLES = [
  ...
  "Prestação de contas final da pré campanha",
...
export const CALENDAR_MONTHS: CalendarMonth[] = [
  ...
  },
  {
    ...
    year: 2026,
    month: 8,
    theme: "Intensificação: Pré-Pré campanha Eleitoral",
  ...
  },
  {
    ...
    year: 2026,
    month: 9,
    theme: "Mobilização: Pré campanha Eleitoral Oficial",
